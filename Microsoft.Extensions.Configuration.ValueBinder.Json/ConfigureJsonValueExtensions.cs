...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ConfigureValueExtensions
    {
        ...
        /// <summary>Attempts to bind the given object instance to configuration section value by JsonConfigurationProvider.</summary>
        ...
        public static IServiceCollection ConfigureJsonValues<TOptions>(this IServiceCollection services, IConfiguration configuration) where TOptions : class =>
            services.ConfigureValues<TOptions>(configuration, ProviderCreator);

        /// <summary>Attempts to bind the given object instance to configuration section value by JsonConfigurationProvider.</summary>
        /// <param name="services">The <see cref="T:IServiceCollection" /> to add the service to.</param>
        /// <param name="value">The value to bind.</param>
        public static IServiceCollection ConfigureJsonValue<TOptions>(this IServiceCollection services, string value) where TOptions : class =>
        ...
        /// <param name="name">The name of the options instance being watche.</param>
        /// <param name="value">The value to bind.</param>
        public static IServiceCollection ConfigureJsonValue<TOptions>(this IServiceCollection services, string name, [NotNull] string value) where TOptions : class =>
